...
import aureena.patches.relics.BottledPlaceholderField;
import aureena.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static aureena.AureenaMod.makeRelicOutlinePath;
import static aureena.AureenaMod.makeRelicPath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = AureenaMod.makeID("BottledPlaceholderRelic");
